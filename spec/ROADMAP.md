...
[the learning register](register.md#reg-deliver), which is the FuguTTX D10
pattern. No phase starts cloud spend before P2. Every phase is days, not weeks,
because the model is small. This scale mitigates
[the sequencing risk](risks.md#rsk-seq).
