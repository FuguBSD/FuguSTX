...
| P12   | The first SFT campaign on the pair corpus, against the tier T1 thresholds and the bar of phase P11. The first scorecard with categories fixes the category-agreement threshold. The T13 bar decides the pilot.                                                       |
