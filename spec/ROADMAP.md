...
| P11   | The pair corpus: the sources at pinned tags, the memorization check, the two generators, the judge filter, and the zero-training baseline of decision T13. The baseline run fixes the tier T1 thresholds, and the operator sets the T13 bar after it. |
