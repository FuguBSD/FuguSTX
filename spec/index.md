...
- A citation of a unit of a sibling repository is a prose token with the
  ...
  tables included.
- A marker of the form "Rehearses: FuguTTX IAC-TRAIN" ties a component to the
  FuguTTX unit that it rehearses.
...
| Document                     | Role                                                  |
| ---------------------------- | ----------------------------------------------------- |
| [overview.md](overview.md)   | Goals, the pilot statement, accepted costs, the name. |
